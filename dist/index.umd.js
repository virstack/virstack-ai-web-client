var VirstackAIWebClient = (() => {
  ...
  var require_eventemitter3 = __commonJS({
    "node_modules/eventemitter3/index.js"(exports, module) {
      ...
      EventEmitter3.prototype.removeListener = function removeListener2(event, fn, context, once3) {
        var evt = prefix ? prefix + event : event;
    ...
    resumeConnection(reason) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          ...
          if (error instanceof ConnectionError && error.reason === 0) {
            throw new UnexpectedConnectionState("could not reconnect, token might be expired");
          }
          if (error instanceof ConnectionError && error.reason === 4) {
            throw error;
          }
  ...
  var Participant = class extends eventsExports.EventEmitter {
    ...
    constructor(sid, identity, name, metadata, loggerOptions) {
      let kind = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : ParticipantInfo_Kind.STANDARD;
      var _a;
      super();
      this.audioLevel = 0;
  ...
  var LocalParticipant = class extends Participant {
    ...
    constructor(sid, identity, engine, options) {
      super(sid, identity, void 0, void 0, {
        loggerName: options.loggerName,
  ...
  var RemoteParticipant = class _RemoteParticipant extends Participant {
    ...
    static fromParticipantInfo(signalClient, pi, loggerOptions) {
      return new _RemoteParticipant(signalClient, pi.sid, pi.identity, pi.name, pi.metadata, loggerOptions, pi.kind);
    }
    get logContext() {
  ...
  var Room = class extends eventsExports.EventEmitter {
    ...
    constructor(options) {
          ...
          return (function* () {
            ...
            try {
              ...
              if (_this2.state === ConnectionState.Connecting || _this2.state === ConnectionState.Reconnecting || _this2.isResuming) {
                ...
                (_c = (_b2 = _this2.connectFuture) === null || _b2 === void 0 ? void 0 : _b2.reject) === null || _c === void 0 ? void 0 : _c.call(_b2, new ConnectionError("Client initiated disconnect"));
      ...
      this.onLocalTrackPublished = (pub) => __awaiter(this, void 0, void 0, function* () {
        ...
        (_d = (_c = (_b2 = pub.track) === null || _b2 === void 0 ? void 0 : _b2.getProcessor()) === null || _c === void 0 ? void 0 : _c.onPublish) === null || _d === void 0 ? void 0 : _d.call(_c, this);
    ...
    createParticipant(identity, info) {
      ...
      if (info) {
        ...
        participant = new RemoteParticipant(this.engine.client, "", identity, void 0, void 0, {
          loggerContextCb: () => this.logContext,
          loggerName: this.options.loggerName
        });
      }
