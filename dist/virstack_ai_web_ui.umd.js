  ...
  (function() {
    ...
    class VirstackAIWebUIWidget {
      ...
      createWidget() {
        ...
        const imageElement = this.config.agentImageUrl ? `<img src="${this.config.agentImageUrl}" alt="AI Agent" class="virstack-agent-image">` : `<div class="virstack-agent-placeholder">\u{1F916}</div>`;
        wrapper.innerHTML = `
      ...
      showStatus(message, type = "default", duration = 3e3) {
      ...
      async startCall() {
        ...
        try {
          ...
          this.showStatus("Authenticating...", "connecting", 1e4);
          const accessToken = await this.fetchAccessToken();
          this.showStatus("Connecting...", "connecting", 1e4);
          ...
          this.virstackWebClient.on("call_started", () => {
            ...
            this.showStatus("Connected - Listening", "connected", 2e3);
          });
